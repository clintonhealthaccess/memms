...
<table class="items">
	<thead>
		<tr>
			...
			<g:sortableColumn property="firstOccurenceOn"  title="${message(code: 'preventive.order.open.on.label')}" params="[q:q,'equipment.id':equipment?.id,'dataLocation.id':dataLocation?.id]" />
